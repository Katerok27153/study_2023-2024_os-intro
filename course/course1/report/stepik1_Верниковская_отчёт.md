...
Задание №2: прочитав критерии прохождения курса, я отметил необходимые утверждения (рис. [-@fig:002])
...
Задание №4: на свой компьютер я устанавливал программу VirtualBox, которая нужна для подключения одной операционной системы на другую (рис. [-@fig:004])
...
Задание №6: я создал документ, и перед сохранением выбрала нужный формат, а после прикрепил его к курсу (рис. [-@fig:006]), (рис. [-@fig:007]), (рис. [-@fig:008])
...
Задание №8: программа медиапроигрыватель VLC у меня уже была установлена по умолчанпю. Открыв информацию о программе я посмотрел как зовут автора (рис. [-@fig:010]), (рис. [-@fig:011]), (рис. [-@fig:012])
...
Задание №12: я посмотрел вывод всех команд, предложенных в задании и выбрал те, которые эквиваленты команде *ls -A --human-readable -l /some/directory* (рис. [-@fig:016]), (рис. [-@fig:017])

![Вывод команды ls -A --human-readable -l /some/directory](image/ST1_16.png){#fig:016 width=70%}

Задание №13: я выполнил задание через терминал. Плучилось, что подходят все варианты (рис. [-@fig:018])
...
Задание №15: это я проверил на практике (рис. [-@fig:020])
...
Задание №17: скачал нужный файл, сделал его исполняемым и запустил (рис. [-@fig:022]), (рис. [-@fig:023]), (рис. [-@fig:024])

![Выполнение задания №17 (1)](image/ST1_22.png){#fig:022 width=70%}

![Задание №17](image/ST1_24.png){#fig:023 width=70%}
...
![Задание №18](image/ST1_25.png){#fig:024 width=70%}
...
Поэтому подходят только первые два варианта, которые создадут файл file.txt и запишут в него поток ошибок программы program (рис. [-@fig:025])

![Задание №19](image/ST1_26.png){#fig:025 width=70%}
...
Подходит первый вариант (рис. [-@fig:026])

![Задание №20](image/ST1_27.png){#fig:026 width=70%}
...
Задание №22: чтобы узнать правильный ответ я воспользовался командой *man wget*  (рис. [-@fig:030])
...
Задание №28: создал текстовый документ с нужными строками и проверил вывод с помощью команды *grep "world" text.txt* (рис. [-@fig:036]), (рис. [-@fig:037]), (рис. [-@fig:038])

![Выполнение задания №28 (1)](image/ST1_36.png){#fig:036 width=70%}

![Задание №28](image/ST1_38.png){#fig:038 width=70%}

Задание №29: скачал архив с произведением Шекспира. Далее проделал действия для генерации файла, в котором будут все строчки, содержащие слово "love" (рис. [-@fig:039]), (рис. [-@fig:040]), (рис. [-@fig:041]), (рис. [-@fig:042]), (рис. [-@fig:043])
...
В ходе выполнения 1 этапа внешних курсов на stepik я освоил linux, terminal, запуск исполняемых фалов, а также научился работать с архивами и искать слова в файлах через командную строку.
